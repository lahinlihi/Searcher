...
_BUSINESS_TYPE_CATEGORIES = [
    ('교육운영', 50, [
        ...
        '연수 기관 선정', '교육운영 위탁',
        # 평생학습·러닝 그라운드·학습공간 운영
        '평생학습 운영', '평생학습운영', '평생교육 운영', '평생교육운영',
        '평생학습', '평생교육원',
        '러닝 그라운드', '러닝그라운드', '학습 공간 운영', '학습공간 운영',
        '학습센터 운영', '학습지원 운영',
        # 인력양성·인재육성 (기타채널: 과기정통부·NIA·정보통신산업진흥원 등)
        '인력양성', '인력 양성', '양성 교육', '교육 사업',
        '연수사업', '인력교류사업', '훈련사업',
        '인재양성', '인재 양성', '전문인력 양성',
        # 양성 운영 (창업가·전문가 등 대상 양성 과정 운영)
        '양성 운영', '양성운영', '양성 과정 운영', '양성과정 운영',
        # 강사·튜터 관련
        '강사 양성', '강사양성', '튜터 양성', '교강사',
        '강사 풀', '강사풀', '강사 Pool',
        # 교육 성과 행사 (발표대회·성과공유회 등 교육 프로그램 결과 행사)
        '성과공유회', '성과 공유회', '성과발표회', '성과 발표회',
        '발표대회 심사', '발표대회 운영', '진로연계교육',
        '교육 성과', '학습 성과 공유',
        # 교육 파트너(위탁기관/운영기관과 동일 개념, 표현만 다른 경우)
        '교육파트너', '교육 파트너', '교육파트너사', '교육 파트너사',
        '연수파트너', '연수 파트너', '훈련파트너', '훈련 파트너',
    ]),
    ('시설운영', 40, [
        # 센터/시설/공간 + 운영/위탁
    ...
    ('행사운영', 30, [
        ...
        # 행사 대행·위탁 (컨설팅·교육 등 내용과 무관하게 행사 수행 형태)
        '행사 대행', '행사대행', '행사 운영 대행', '행사 위탁',
        '이벤트 대행', '이벤트대행', '이벤트 운영',
        '박람회 운영', '박람회 개최',
        '포럼 운영', '포럼 개최',
        '세미나 운영', '세미나 개최',
        ...
        '피칭 행사', '피칭 대회',
        '페스티벌 운영', '페스티벌 개최',
        # 행사·이벤트 성격 운영 용역 (러닝 그라운드·축전·챌린지 등)
        '축전 운영', '페어 운영', '어워드 운영', '챌린지 운영',
        '랠리 운영', '마라톤 운영', '올림피아드 운영',
    ]),
    ('사업운영', 35, [
        ...
        '지원사업 운영', '사업 수탁', '사업수탁', '수탁사업',
        '사업 운영기관', '사업 운영 위탁',
        # 사업자 선정 (운영·수행 사업자 공모)
        '운영 사업자 선정', '수행 사업자 선정', '운영사업자 선정',
        # 거점·허브·센터 운영지원
        '허브 운영', '허브운영',
        '운영지원기관', '운영 지원 기관',
        # 사업지원단·추진단 운영
